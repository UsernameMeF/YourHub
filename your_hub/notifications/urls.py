...
urlpatterns = [
    ...
    path('api/recent/', views.RecentNotificationsAPIView.as_view(), name='api_recent'),
    path('api/mark-read/<int:notification_id>/', views.MarkNotificationAsReadAPIView.as_view(), name='api_mark_read'),
    path('api/unread-count/', views.UnreadNotificationCountAPIView.as_view(), name='api_unread_count'), 
